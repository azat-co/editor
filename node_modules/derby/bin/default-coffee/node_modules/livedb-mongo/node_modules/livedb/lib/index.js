...
exports.client = function(options) {
  var atomicSubmit, client, extraDbs, fetchNoCache, getDocOpChannel, getOpLogKey, getOps, getVersionKey, logEntryForData, nextStreamId, oplog, oplogGetOps, prefixChannel, processRedisOps, redis, redisCacheVersion, redisGetOps, redisObserver, redisSetExpire, redisSubmitScript, snapshotDb, streams, subscribeCounts, writeOpToLog;
  ...
  fetchNoCache = function(cName, docName, callback) {
    var _this = this;
  ...
  return client = {
    ...
    submit: function(cName, docName, opData, options, callback) {
      ...
      return (retry = function() {
        return fetchNoCache(cName, docName, function(err, snapshot) {
          var trySubmit;
          if (err) {
            return typeof callback === "function" ? callback(err) : void 0;
          }
